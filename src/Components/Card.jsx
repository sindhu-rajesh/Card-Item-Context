  ...
  return (
    <>
      {products.map((product, i) => {
        ...
        const [cardAmountState, setCardAmountState] = useState(0);

        useEffect(() => {
          setCardAmountState(cardAmountState + +subTotal);
          setCardAmount(cardAmountState + +subTotal);
        }, );
        ...
        const handleQuantitySub = (priceAfterDiscount, quantity) => {
          if (quantity > 1) {
            ...
            setCardAmountState(cardAmountState - +priceAfterDiscount);
            setCardAmount(cardAmountState - +priceAfterDiscount);
          }
        };
        ...
        return (
          <div key={i} className="col-12 d-flex justify-content-center align-items-center ">
            <div
              className="card mb-3"
